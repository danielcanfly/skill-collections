...
REQUIRED_HEADERS = {
    ...
    "research/case_registry.csv": ["case_id","case_type","title","domain","jurisdiction_or_context","decision_or_problem","source_ids","evidence_family_ids","independence_status","independence_rationale","mechanism","what_was_known_at_the_time","outcome","decision_quality_interpretation","transfer_limit","status"],
...
def main():
    ...
    for rel in [
        ...
        "research/source_identity_verification.csv","research/edge_entailment.csv","research/contextual_relevance_register.csv",
        "qa/validate_source_identity.py","qa/validate_edge_entailment.py","qa/validate_contextual_relevance.py","qa/validate_lineage_cascade.py","qa/validate_node_semantic_diversity.py","qa/validate_disposition_status.py","qa/validate_temporal_metadata.py","qa/validate_case_independence.py","qa/validate_topic_red_team.py","qa/validate_seal_state.py"
    ]:
