...
REQUIRED_HEADERS = {
    ...
    "research/claim_ledger.csv": ["claim_id","module_id","claim","claim_type","source_id","evidence_family_id","support_challenge","scope","confidence","candidate_node","notes"],
    ...
    "research/source_metadata_reconciliation.csv": ["source_id","current_title","verified_title","verified_authors","verified_year","verified_source_type","verified_publisher","verified_doi_or_url","access_status","verification_status","action","evidence_family_id","notes"],
